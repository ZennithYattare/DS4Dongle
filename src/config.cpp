...
#ifdef DS4_CONFIG_FLASH_OFFSET
#define DS4_CONFIG_FLASH_OFFSET_EXPLICIT 1
#else
#define DS4_CONFIG_FLASH_OFFSET (PICO_FLASH_SIZE_BYTES - FLASH_SECTOR_SIZE)
#endif
constexpr uint32_t CONFIG_FLASH_OFFSET = DS4_CONFIG_FLASH_OFFSET;
...
#if defined(DS4_CONFIG_FLASH_OFFSET_EXPLICIT) && defined(PICO_FLASH_BANK_STORAGE_OFFSET)
